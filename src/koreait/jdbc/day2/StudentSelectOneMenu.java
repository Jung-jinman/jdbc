...
public class StudentSelectOneMenu {
	...
	public static void main(String[] args) {
		...
		System.out.println("==================== 학생을 학번을 조회하는 메뉴 ====================");
...
private static void selectOneStudent(Connection conn) {
		...
		try(
			...
			// 조회 결과 유무를 알려면 '제일 먼저 실행해야 할 메소드-조회 결과 첫 번째 행으로 이동' 입니다.
			...
			System.out.println("조회 결과 첫 번째 컬럼의 값 : " + rs.getString(1));
			System.out.println("조회 결과 두 번째 컬럼의 값 : " + rs.getString(2));
			System.out.println("조회 결과 세 번째 컬럼의 값 : " + rs.getInt(3));
			System.out.println("조회 결과 네 번째 컬럼의 값 : " + rs.getString(4));
